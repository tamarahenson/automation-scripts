...
subjectAltName=IP:192.168.189.128
EOF


echo "Creating SSL Cert"
openssl req -newkey rsa:4096 -nodes -sha256 -keyout "$(pwd)"/certs/domain.key -x509 -days 365 -out "$(pwd)"/certs/domain.crt -subj "/C=US/ST=IL/L=Chicago/O=Dis/CN=192.168.2.12"
